...
model WolfCGB50_GC "WolfCGB20 validated with CoSES mearusements"
...
<TITLE>WolfCGB20 validated with CoSES mearusements</TITLE> 
<STYLE type=\"text/css\">
...
<BODY>
<H1>WolfCGB20 validated with CoSES mearusements</H1>
<HR>
...
<TABLE class=\"type\">
  ...
  <TR>
    <TH>Identifier:</TH>
    <TD colspan=\"3\">CoSES_Models.HeatGenerator.DigitalTwins.WolfCGB50_GC</TD></TR>
  <TR>
    <TH>Version:</TH>
    <TD colspan=\"3\">1.0</TD></TR>
  <TR>
    <TH>File:</TH>
    <TD colspan=\"3\">WolfCGB50_GC.mo</TD></TR>
  <TR>
    <TH>Connectors:</TH>
...
<H2>Description:</H2>
<P><FONT size=\"2\">The model represents the CGB50 condensing boiler from Wolf  
...
<UL>
  ...
  <LI><FONT color=\"#465e70\" size=\"2\">QEl_phase - reactive power of the three     
      phases (only phase 1 is active)</FONT></LI></UL><FONT color=\"#465e70\" size=\"2\"><FONT 
size=\"2\">
...
<UL><FONT color=\"#465e70\" face=\"Arial\" size=\"2\"></FONT>         
  ...
  face=\"Arial\" size=\"2\">Start-up   process: The   behavior is provided by a time 
          dependent look-up   table.</FONT></SPAN></LI><FONT color=\"#465e70\" 
  ...
  efficiency depends on the return temperature and power   modulation and is     
      defined by a two-dimensional look-up table. Load changes   during   
  steady-state       are modeled with a rising or falling           
  ...
  color=\"#465e70\" face=\"Arial\" size=\"2\">Shut-down   process: Similar to the      
     start-up process, the shut-down process is provided by   a time dependent   
        look-up  
 table.</FONT></SPAN></SPAN></SPAN></SPAN></LI></UL></FONT></SPAN></FONT></FONT></FONT> 
</BODY></HTML>
"),
		experiment(
			StopTime=1,
