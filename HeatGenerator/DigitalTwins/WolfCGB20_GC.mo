...
model WolfCGB20_GC "WolfCGB20 validated with CoSES mearusements"
...
<TABLE class=\"type\">
  ...
  <TR>
    <TH>Identifier:</TH>
    <TD colspan=\"3\">CoSES_Models.HeatGenerator.DigitalTwins.WolfCGB20_GC</TD></TR>
  <TR>
    <TH>Version:</TH>
    <TD colspan=\"3\">1.0</TD></TR>
  <TR>
    <TH>File:</TH>
    <TD colspan=\"3\">WolfCGB20_GC.mo</TD></TR>
  <TR>
    <TH>Connectors:</TH>
...
<H2>Description:</H2>
<P><FONT size=\"2\">The model represents the CGB20 condensing boiler from Wolf 
...
<UL><FONT color=\"#465e70\" face=\"Arial\" size=\"2\"></FONT>     
  ...
  look-up 
table.</FONT></SPAN></SPAN></SPAN></SPAN></LI></UL></FONT></SPAN></FONT></FONT></FONT></BODY></HTML>
"),
		experiment(
			StopTime=1,
			StartTime=0,
