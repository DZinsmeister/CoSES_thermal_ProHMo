...
model WolfCGB20 "WolfCGB20 validated with CoSES mearusements"
	...
	Controller.CBControlWolf cBControlWolf1(
		FlowTemperatureSet(tableID "External table object"),
		PowerSet(tableID "External table object"),
		TableDeltaTFactor(tableID "External table object"),
	...
	CondensingBoiler condensingBoiler_DZ1(
		PelCP(tableID "External table object"),
		QMax(tableID "External table object"),
		QMin(tableID "External table object"),
		etaNom(tableID "External table object"),
		QFile="C:\Users\Public\Documents\SimulationX 4.2\Modelica\CoSES_Models\Data\Heat Generator\Condensing Boiler\Wolf_CBG_20.txt",
