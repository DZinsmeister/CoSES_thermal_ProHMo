...
model SimX_Pipe_MF5toSF1_high "Pipe model"
	...
	GreenCity.Utilities.Thermal.Pipe pipe1(
		QLossCoefficient(displayUnit="W/(m·K)")=Pipe_MF5toSF1_high_QLossCoefficient_W_per_mK,
		lPipe=Pipe_MF5toSF1_high_lPipe_m,
		dPipe(displayUnit="m")=Pipe_MF5toSF1_high_dPipe_cm/100,
		TPipeInit(displayUnit="K")=Pipe_MF5toSF1_high_TPipeInit_degC+273.15) annotation(Placement(transformation(extent={{-5,10},{15,20}})));
	...
	parameter Real Pipe_MF5toSF1_high_dPipe_cm=10 "Pipe diameter" annotation(Dialog(group="Parameters"));
	parameter Real Pipe_MF5toSF1_high_lPipe_m=20 "Pipe length" annotation(Dialog(group="Parameters"));
	parameter Real Pipe_MF5toSF1_high_QLossCoefficient_W_per_mK=0.19 "Heat loss coefficient through insulation" annotation(Dialog(group="Parameters"));
	parameter Real Pipe_MF5toSF1_high_TPipeInit_degC=30 "Initial water temperature in the pipe" annotation(Dialog(group="Parameters"));
	...
	annotation(
		...
		__esi_viewinfo[2](
			projectName="Pipe_MF5toSF1_high",
			...
			outputs[1](
				...
				typename="CEPort"),
			parameters[0](
				port="Pipe_MF5toSF1_high_dPipe_cm",
				interpolation=true,
				paramTypeSPCK=3,
				typename="CEPort"),
			parameters[1](
				port="Pipe_MF5toSF1_high_lPipe_m",
				interpolation=true,
				paramTypeSPCK=3,
				typename="CEPort"),
			parameters[2](
				port="Pipe_MF5toSF1_high_QLossCoefficient_W_per_mK",
				interpolation=true,
				paramTypeSPCK=3,
				typename="CEPort"),
			parameters[3](
				port="Pipe_MF5toSF1_high_TPipeInit_degC",
				interpolation=true,
				paramTypeSPCK=3,
				typename="CEPort"),
...
<TABLE class=\"type\">
  ...
  <TR>
    <TH>Identifier:</TH>
    <TD 
      colspan=\"3\">CoSES_Models.CodeExport.VeriStandPipeModels.SimX_Pipe_MF5toSF1_high</TD></TR>
  <TR>
    <TH>Version:</TH>
    <TD colspan=\"3\">1.0</TD></TR>
  <TR>
    <TH>File:</TH>
    <TD colspan=\"3\">SimX_Pipe_MF5toSF1_high.mo</TD></TR>
  <TR>
    <TH>Connectors:</TH>
  ...
  <TR>
    <TH>&nbsp;</TH>
    <TD>Pipe diameter</TD>
    <TD>Pipe_MF5toSF1_high_dPipe_cm</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Pipe length</TD>
    <TD>Pipe_MF5toSF1_high_lPipe_m</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Heat loss coefficient through insulation</TD>
    <TD>Pipe_MF5toSF1_high_QLossCoefficient_W_per_mK</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Initial water temperature in the pipe</TD>
    <TD>Pipe_MF5toSF1_high_TPipeInit_degC</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>Results:</TH>
    <TD>Temperature at the end of the pipe</TD>
