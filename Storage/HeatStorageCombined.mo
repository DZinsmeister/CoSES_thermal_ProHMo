...
model HeatStorageCombined "Heat storage with variable temperature profile"
	...
	public
		...
		GreenCity.Interfaces.Thermal.ExtractVolumeFlow FromReturn4 if use4 "Input signal return pipe 4" annotation(Placement(transformation(extent={{340,-95},{320,-75}})));
		GreenCity.Interfaces.Thermal.DefineVolumeFlow ToFlow4 if use4 "Output signal flow pipe 4" annotation(Placement(transformation(extent={{320,-30},{340,-10}})));
		GreenCity.Interfaces.Thermal.DefineVolumeFlow ToFlow5 if use5 "Output signal flow pipe 5" annotation(Placement(transformation(extent={{320,-160},{340,-140}})));
		GreenCity.Interfaces.Thermal.ExtractVolumeFlow FromReturn5 if use5 "Input signal return pipe 5" annotation(Placement(transformation(extent={{340,-215},{320,-195}})));
		GreenCity.Interfaces.Thermal.DefineVolumeFlow ToFlow6 if use6 "Output signal flow pipe 6" annotation(Placement(transformation(extent={{320,-265},{340,-245}})));
		GreenCity.Interfaces.Thermal.ExtractVolumeFlow FromReturn6 if use6 "Input signal return pipe 6" annotation(Placement(transformation(extent={{340,-315},{320,-295}})));
	protected
		Real TLayer[n](
			quantity="Thermics.Temp",
	...
	public
		Real PStorage[7](
			quantity="Basics.Power",
			displayUnit="kW") "Supplied/abstracted heat power of each pipe (0-6) and the el. heater (7)" annotation(Dialog(
			group="Heating Power",
			tab="Results 1",
			visible=false));
	protected
	...
	public
		...
		Real EHeat[7](
			quantity="Basics.Energy",
			displayUnit="kWh") "Heat input/output of each pipe (0-6) and the el. heater (7)" annotation(Dialog(
			group="Energy",
			tab="Results 1",
			visible=false));
		Real Eel(
	...
	protected
		...
		Boolean ElOn "On conditions for electric heater are true" annotation(
			...
			Dialog(
				group="Usage",
				tab="Results 1"));
		Boolean use[6] "Vector for usage definition for each pipe" annotation(Dialog(
			group="Usage",
			tab="Results 1"));
		Boolean HE[6] "Vector for installation type definitions of each pipe" annotation(Dialog(
			group="Usage",
			tab="Results 1"));
		Integer index[6,2] "Layer index array for flow(1) and return (2) pipes" annotation(Dialog(
			group="Usage",
			tab="Results 1"));
		Boolean indexRange[n,6] "Usage definition of each (virtual) HE-section" annotation(Dialog(
			group="Usage",
			tab="Results 1"));
		Integer HEsize[6] "Vector for HE-pipe sizes - number of heat storage layers of a HE" annotation(Dialog(
			group="Usage",
			tab="Results 1"));
		Real qv[6](
		...
		Real VDiff[n](
			...
			group="Volume Flow",
			tab="Results 1"));
		Real CalcVDiffPot[n,2] "Calculation variable for volume shifting potential" annotation(Dialog(
			group="Volume Flow",
			tab="Results 1"));
		Real VDiffPot[n,2](
			quantity="Geometry.Volume",
...
5228303F71A1D5510FE1E20E31E8A3A823E03FB6BA1FB6791BF092E9CD60C6762F66AB1FB2DD7BC0344E6BA78DB932DB7B25D8DEE930A57F000000FFFF" "Spalte 2") "Table including temperature specific density of heat medium" annotation(
		...
		parameter Boolean use1=false "True=pipe 1 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 1 - Heat Supply"));
		...
		parameter Boolean use2=false "True=pipe 2 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 2 - Heat Supply"));
		...
		parameter Boolean use3=false "True=pipe 3 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 3 - Heat Supply"));
		...
		parameter Boolean use4=false "True=pipe 4 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 4 - Heat Extraction"));
		...
		parameter Real rhoHeatExchanger4(
			quantity="Basics.Density",
			displayUnit="kg/m³")=1000 if use4 and HE4 "HE-media densitiy 4" annotation(Dialog(
			group="Heat Exchanger - Medium",
			tab="Flow/Return Pipe 4 - Heat Extraction"));
		...
		parameter Boolean use5=false "True=pipe 5 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 5 - Heat Extraction"));
		...
		parameter Real rhoHeatExchanger5(
			quantity="Basics.Density",
			displayUnit="kg/m³")=1000 if use5 and HE5 "HE-media densitiy 5" annotation(Dialog(
			group="Heat Exchanger - Medium",
			tab="Flow/Return Pipe 5 - Heat Extraction"));
		...
		parameter Boolean use6=false "True=pipe 6 is used" annotation(Dialog(
			group="Usage",
			tab="Flow/Return Pipe 6 - Heat Extraction"));
		...
		GreenCity.Interfaces.Thermal.VolumeFlowIn FlowIn1 if use1 "Flow pipe 1" annotation(Placement(
			...
			iconTransformation(extent={{-185,307},{-165,327}})));
		GreenCity.Interfaces.Thermal.VolumeFlowOut ReturnOut1 if use1 "Return pipe 1" annotation(Placement(
			...
			iconTransformation(extent={{-185,207},{-165,227}})));
		GreenCity.Interfaces.Thermal.VolumeFlowIn FlowIn2 if use2 "Flow pipe 2" annotation(Placement(
			...
			iconTransformation(extent={{-185,57},{-165,77}})));
		GreenCity.Interfaces.Thermal.VolumeFlowOut ReturnOut2 if use2 "Return pipe 2" annotation(Placement(
			...
			iconTransformation(extent={{-185,-43},{-165,-23}})));
		GreenCity.Interfaces.Thermal.VolumeFlowIn FlowIn3 if use3 "Flow pipe 3" annotation(Placement(
			...
			iconTransformation(extent={{-185,-193},{-165,-173}})));
		GreenCity.Interfaces.Thermal.VolumeFlowOut ReturnOut3 if use3 "Return pipe 3" annotation(Placement(
			...
			iconTransformation(extent={{-185,-293},{-165,-273}})));
		GreenCity.Interfaces.Thermal.VolumeFlowOut FlowOut4 if use4 "Flow pipe 4" annotation(Placement(
			transformation(extent={{365,-30},{385,-10}}),
			iconTransformation(extent={{165,307},{185,327}})));
		GreenCity.Interfaces.Thermal.VolumeFlowIn ReturnIn4 if use4 "Return pipe 4" annotation(Placement(
			transformation(extent={{365,-95},{385,-75}}),
			iconTransformation(extent={{165,207},{185,227}})));
		GreenCity.Interfaces.Thermal.VolumeFlowOut FlowOut5 if use5 "Flow pipe 5" annotation(Placement(
			transformation(extent={{365,-160},{385,-140}}),
			iconTransformation(extent={{165,57},{185,77}})));
		GreenCity.Interfaces.Thermal.VolumeFlowIn ReturnIn5 if use5 "Return pipe 5" annotation(Placement(
	...
	equation
		if UseElHeater then
			...
			if Phase==1 then
				connect(Grid1,GridConnection1.FlowCurrent);
			end if;
			if Phase==3 then
				connect(Grid3,GridConnection3.LVFlowCurrent);
			end if;
		else
			for i in 1:n loop
				PLayer[i]=0;
				...
				if (use[4]) then
					qv[4]=FromReturn4.qvMedium;
					TIn[4]=FromReturn4.TMedium;
				else
					qv[4]=0;
					TIn[4]=0;
				end if;
				if (use[5]) then
					qv[5]=FromReturn5.qvMedium;
					TIn[5]=FromReturn5.TMedium;
				else
					qv[5]=0;
					TIn[5]=0;
				end if;
				...
				for i in 1:n loop
					VIn[i]=VPipeIn[i,1]+VPipeIn[i,2]+VPipeIn[i,3]+VPipeIn[i,4]+VPipeIn[i,5]+VPipeIn[i,6];
					VOut[i]=VPipeOut[i,1]+VPipeOut[i,2]+VPipeOut[i,3]+VPipeOut[i,4]+VPipeOut[i,5]+VPipeOut[i,6];
					deltaTin[i]=(TIn[1]-TLayer[i])*(VPipeIn[i,1]/(VStorage/n))+(TIn[2]-TLayer[i])*(VPipeIn[i,2]/(VStorage/n))+(TIn[3]-TLayer[i])*(VPipeIn[i,3]/(VStorage/n))+(TIn[4]-TLayer[i])*(VPipeIn[i,4]/(VStorage/n))+(TIn[5]-TLayer[i])*(VPipeIn[i,5]/(VStorage/n))+(TIn[6]-TLayer[i])*(VPipeIn[i,6]/(VStorage/n));
				...
				if use4 then
					ToFlow4.qvMedium=qv[4];
					ToFlow4.TMedium=TOut[4];
				end if;
				if use5 then
					ToFlow5.qvMedium=qv[5];
					ToFlow5.TMedium=TOut[5];
				end if;
				if use6 then
		...
		connect(ReturnOut3,ToReturn3.Pipe) annotation(Line(points=0));
			...
			if use4 then
			connect(FlowOut4,ToFlow4.Pipe) annotation(Line(points=0));
		connect(ReturnIn4,FromReturn4.Pipe) annotation(Line(points=0));
		end if;
			if use5 then
			connect(FlowOut5,ToFlow5.Pipe) annotation(Line(points=0));
		connect(ReturnIn5,FromReturn5.Pipe) annotation(Line(points=0));
		end if;
			if use6 then
...
<TITLE>Heat storage with variable temperature profile</TITLE> 
<STYLE type=\"text/css\">
...
<BODY>
<H1>Heat storage with variable temperature profile</H1>
...
<TABLE class=\"type\">
  ...
  <TR>
    <TH>Identifier:</TH>
    <TD colspan=\"3\">CoSES_Models.Storage.HeatStorageCombined</TD></TR>
  <TR>
    <TH>Version:</TH>
    <TD colspan=\"3\">1.0</TD></TR>
  <TR>
    <TH>File:</TH>
    <TD colspan=\"3\">HeatStorageCombined.mo</TD></TR>
  <TR>
    <TH>Connectors:</TH>
  ...
  <TR>
    <TH>&nbsp;</TH>
    <TD>Input signal return pipe 4</TD>
    <TD>FromReturn4</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Output signal flow pipe 4</TD>
    <TD>ToFlow4</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Output signal flow pipe 5</TD>
    <TD>ToFlow5</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
    <TD>Input signal return pipe 5</TD>
    <TD>FromReturn5</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
  ...
  <TR>
    <TH>&nbsp;</TH>
    <TD>Supplied/abstracted heat power of each pipe (0-6) and the el. heater   
          (7)</TD>
    <TD>PStorage</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
  ...
  <TR>
    <TH>&nbsp;</TH>
    <TD>Heat input/output of each pipe (0-6) and the el. heater (7)</TD>
    <TD>EHeat</TD>
    <TD>&nbsp;</TD></TR>
  <TR>
    <TH>&nbsp;</TH>
